export function messages(_) {
  return [
    ...
    _("Use Ctrl+Enter to launch multiple apps or new instances of already open apps"),
    _("System settings sections are also available for launching, just search for them!"),
  ]
};
